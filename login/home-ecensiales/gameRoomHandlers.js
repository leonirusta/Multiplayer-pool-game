...
const createGameCard = (gameData) => {
    ...
    if (gameData.isSimulated) {
        ...
        const statusDisplay = `<div class="card-game-details"><span class="card-status-active" style="color: ${statusColor}; font-weight: bold; cursor: ${cursor};">${statusText}</span></div>`;
        cardHTML = `
